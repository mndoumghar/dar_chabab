...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check->num_rows > 0) {
        ...
        // Enregistrement
        $stmt = $conn->prepare("INSERT INTO membres (nom, email, password, age, telephone) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("sssis", $nom, $email, $motdepasse, $age, $telephone);
        if ($stmt->execute()) {
...
<head>
    ...
    <title>Inscription | Maison de la Jeunesse</title>
    ...
    <div class="container">
        <form method="POST" class="register-form">
            ...
            <div class="input-group">
                ...
                <input type="number" id="age" name="age" placeholder="Votre âge" min="12" max="120" required>
            </div>
            
            <div class="input-group">
                <label for="telephone"><i class="fas fa-phone"></i> Téléphone</label>
                <input type="tel" id="telephone" name="telephone" placeholder="06 12 34 56 78" pattern="[0-9]{10}" required>
            </div>
